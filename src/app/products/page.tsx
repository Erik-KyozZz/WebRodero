  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <div>
          <h1 className="text-3xl font-bold text-white">Catálogo de Presets & Servicios</h1>
          <p className="text-slate-400 text-sm mt-1">Cadenas de mezcla vocal digitales y producción de canciones a medida</p>
        </div>
      </div>
