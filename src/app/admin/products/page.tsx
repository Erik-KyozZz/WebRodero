...
import { Plus, Edit2, Trash2, CheckCircle2, XCircle, Sliders, ArrowUp, ArrowDown, X } from "lucide-react";
    ...
    <div className="space-y-6 w-full">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-slate-400 text-sm mt-1">Usa las flechas para subir/bajar la posición de visualización en la tienda</p>
        </div>
        <button
      ...
      {/* Modal Form integrado sin capa de oscurecimiento (Backdrop) que se corte con el header */}
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pt-20">
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-4 text-sm overflow-y-auto pr-1 flex-1">
              ...
              <div>
                <label className="block text-slate-400 text-xs uppercase mb-1">Enlace de Descarga (Drive / Dropbox)</label>
                <input
                  type="url"
